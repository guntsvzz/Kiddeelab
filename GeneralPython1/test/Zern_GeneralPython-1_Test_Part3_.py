menu = {'Appetizers':[{'00':'GarlicBread'},
                      {'01':'CheesePlate'},
                      {'02':'Nachos'}],
        'SaladAndSoups':[{'00':'TossedSalad',
                          '01':'CaesarSalad',
                          '02':'SoupOftheDay'}],
        'Sandwiches':[{'00':'GrilledChickenSandwich'},
                      {'01':'VeggieBurger'},
                      {'02':'SteakSandwich'}],
        'Italian':[{'00':'Spaghetti'},
                   {'01':'PepperoniPizza'},
                   {'02':'HawaiianPizza'},
                   {'03':'Fettucini'}],
        'MainCourse':[{'00':'NewYorkSteak'},
                      {'01':'ChickenStirfy'},
                      {'02':'HeartyStew'},
                      {'03':'FishAndChips'},
                      {'04':'SmokedSalmon'},
        ...
        'Side':[{'00':'FrenchFries'},
                {'01':'Rice'},
                {'02':'GrilledVeggies'}],
        'Desserts':[{'00':'ApplePie'},
                    {'01':'MochaCheesecake'},
                    {'02':'BananaSplit'}],
        'Beverages':[{'00':'DrinkingWater'},
                     {'01':'Milk'},
                     {'02':'Juiuce'},
                     {'03':'SodaPop'}]}
